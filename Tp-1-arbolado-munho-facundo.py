...
Autores: Munho Vital Facundo Nicolas
Descripcion general del contenido:
Fecha de creacion: 27/8/2023
Fecha de ultima modificacion: 27/8/2023
"""
import csv
...
def contar_ejemplares(lista_arboles: list):
    especies_en_parque: list = especies(lista_arboles)
    cant_ejemplares: dict = {}
...
#Ejercicio 5
def obtener_inclinacion(lista_arboles: list, especie: str):
    inclinacion: list = []
    for i in lista_arboles:
        if i["nombre_com"] == especie:
...
#Ejercicio 6
def especimen_mas_inclinado(lista_arboles: list):
    especies_del_parque: list = especies(lista_arboles)
    mayor_inclinacion: float = 0
    mas_inclinados: str = ""
    for i in especies_del_parque:
        inclinaciones: list = obtener_inclinacion(lista_arboles, i)
        max_inclinacion: float = max(inclinaciones)
...
def especie_promedio_mas_inclinada(lista_arboles):
    especies_del_parque: list = especies(lista_arboles)
    mayor_promedio_inclinacion: float = 0
    mas_inclinados_promedio: str = ""
    for i in especies_del_parque:
        inclinaciones:list = obtener_inclinacion(lista_arboles, i)
        max_inclinacion_promedio:float = sum(inclinaciones)/len(inclinaciones)
